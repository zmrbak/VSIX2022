...
///////////////////////////////////////////////
  ...
  // Guid for Standard Shell Commands (Dev16 set)
  #define CMDSETID_StandardCommandSet16 {0x8f380902, 0x6040, 0x4097, {0x98, 0x37, 0xd3, 0xf4, 0x0e, 0x66, 0xf9, 0x08}};
...
#define guidVSStd16                 CMDSETID_StandardCommandSet16
#define CLSID_StandardCommandSet16  CMDSETID_StandardCommandSet16
...
#define IDM_VS_TOOL_FINDRESULTSTABLE  0x0018
...
#define IDG_VS_MM_TOOLS               0x0109    // Tools menu goes here
...
#define IDG_VS_WINDOW_TABORIENTATION  0x0166      // Group for tab well orientation (left, top, right)
...
#define IDG_VS_TASKLIST_COPYONLY               0x01DF
...
// Tab Orientation
#define IDG_VS_EZ_TABORIENTATION        0x01EF
...
#define IDG_VS_FINDRESULTSTABLE               0x02DE
#define IDG_VS_FINDRESULTSTABLE_FINDSTOP      0x02DF
...
#define IDG_VS_CTXT_ITEM_ANALYZE_GENERAL      0x02E5

#define IDG_VS_CTXT_ITEM_EXPLORE              0x02E6
#define IDG_VS_CTXT_XPROJ_PROJITEM_EXPLORE    0x02E7

#define IDG_VS_CTXT_PACKAGEMANAGEMENT         0x02F0
#define IDG_VS_CTXT_REFERENCEMANAGEMENT       0x02F1
#define IDG_VS_CTXT_ASSEMBLYREFERENCE_MANAGE  0x02F2
#define IDG_VS_CTXT_COMREFERENCE_MANAGE       0x02F3
#define IDG_VS_CTXT_PROJECTREFERENCE_MANAGE   0x02F4
#define IDG_VS_CTXT_SDKREFERENCE_MANAGE       0x02F5
#define IDG_VS_CTXT_ITEM_OBJECTBROWSER        0x02F6
...
#define IDM_VS_CSCD_ITEM_ANALYZE              0x036A

#define IDM_VS_EZ_TABORIENTATION      0x0400
...
#define IDM_VS_CTXT_DEPENDENCYTARGET           0X04A0 // Target framework group node
#define IDM_VS_CTXT_REFERENCE_GROUP            0X04A1 // Assembly reference group
#define IDM_VS_CTXT_PACKAGEREFERENCE_GROUP     0x04A2
#define IDM_VS_CTXT_PACKAGEREFERENCE           0x04A3
#define IDM_VS_CTXT_COMREFERENCE_GROUP         0x04A4
#define IDM_VS_CTXT_COMREFERENCE               0x04A5
#define IDM_VS_CTXT_PROJECTREFERENCE_GROUP     0x04A6
#define IDM_VS_CTXT_PROJECTREFERENCE           0x04A7
#define IDM_VS_CTXT_SHAREDPROJECTREFERENCE     0x04A8
#define IDM_VS_CTXT_FRAMEWORKREFERENCE_GROUP   0x04A9
#define IDM_VS_CTXT_FRAMEWORKREFERENCE         0x04AA
#define IDM_VS_CTXT_ANALYZERREFERENCE_GROUP    0x04AB
#define IDM_VS_CTXT_ANALYZERREFERENCE          0x04AC
#define IDM_VS_CTXT_SDKREFERENCE_GROUP         0x04AD
#define IDM_VS_CTXT_SDKREFERENCE               0x04AE
...
#define IDM_VS_CTXT_DEPENDENCY_TRANSITIVE_ITEM      0x04B0 // fallback/default menu
#define IDM_VS_CTXT_TRANSITIVE_ASSEMBLY_REFERENCE   0x04B1 // metadata: "Path"
#define IDM_VS_CTXT_TRANSITIVE_PACKAGE_REFERENCE    0x04B2 // metadata: "Path", "Identity", "Version"
#define IDM_VS_CTXT_TRANSITIVE_PROJECT_REFERENCE    0x04B3 // metadata: "Path", "Identity"
...
#define IDG_VS_TOOLBAR_PROJWIN_NAVIGATION           0x0730  // Contains navigation commands for the Solution Explorer (back, forward, home)
#define IDG_VS_TOOLBAR_PROJWIN_NEWVIEW              0x0731  // Contains the New View toolbar command
#define IDM_VS_CTXT_PROJWIN_FILECONTENTS            0x0732  // Context menu for GraphNode items in the Solution Explorer
#define IDM_VS_CSCD_PROJWIN_FILECONTENTS_SCOPELIST  0x0733  // Flyout menu for changing the view to a different aspect
#define IDG_VS_CTXT_PROJWIN_SCOPE                   0x0734  // Group for containing view-scoping commands (Scope View To This, New View, Change View To)
...
#define IDG_VS_CTXT_PROJWIN_FILECONTENTS_SCOPE      0x0736  // Group specifically for the Item Contents context menu, containing the Scope View To This command
#define IDG_VS_CTXT_PROJWIN_FILECONTENTS_NEWVIEW    0x0737  // Group specifically for the Item Contents context menu, containing the New View command
#define IDG_VS_TOOLBAR_PROJWIN_FILTERS              0x0738  // Group containing common filters for the Solution Explorer (e.g. Opened, Pending Changes)
#define IDM_VS_CTXT_PEEKRESULT                      0x0739  // Context menu for results in Peek
#define IDG_VS_CTXT_PEEKRESULTGROUP                 0x073A  // Contains commands that can run on peek results (Copy Full Path, Promote to Document, Open Containing Folder)

// Context menus and groups for document tab well
#define IDM_VS_CTXT_DOCUMENT_TABWELL                0x0740  // Context menu for document tab wells
#define IDM_VS_CTXT_FLOATING_DOCUMENT_TABWELL       0x0741  // Context menu for floating document tab wells
#define IDG_VS_EZ_DOCWELLOPS                        0x0742
#define IDG_VS_EZ_FLOATALL                          0x0743
#define IDG_VS_EZ_DOCUMENT_TAB_SETTINGS             0x0744  // Group for command to invoke the "Tabs and Windows" page in Tools.Options
#define IDM_VS_CTXT_DOCUMENT_TABWELL_SETTINGS       0x0745  // Context menu for document tab well settings
#define IDG_VS_TABOPT_SORT_ORDER                    0x0746  // Group for tab sort order (alpha, MRO, etc.)
#define IDG_VS_TABOPT_GROUPING                      0x0747  // Group for tab grouping (none, by project)
